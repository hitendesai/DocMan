...
const SEARCH_PAGE_LOCATION = '/dashboard'
const SETTINGS_PAGE_LOCATION = '/dashboard/settings'
const STAT_PAGE_LOCATION = '/dashboard/statistics'
const ACCOUNT_PAGE_LOCATION = '/dashboard/account'
