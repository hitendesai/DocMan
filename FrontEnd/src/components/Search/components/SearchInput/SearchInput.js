...
class SearchInput extends Component {
    ...
    render() {
        ...
        return (
            <div
                style={{ display: 'flex', justifyContent: 'flex-start', flexGrow: '2', margin: '15px', background: 'rgba(255, 255, 255, 0.2)', borderRadius: '6px', boxShadow: '0 0 6px rgba(0, 0, 0, .3)'  }}
            ...
            >
                ...
                <div style={{ display: 'flex', alignItems: 'center', width: '100%'}} > 
                    <TextField
                        ...
                        fullWidth={true}
                        style={{ width: '100%'}}
                        inputStyle={{ color: 'white', width: '100%', height: '28px', top: '10', backgroundColor: 'transparent', disableUnderline: 'true' }}
                        hintStyle={{ color: '#fff' }}
                        hintText={hintText}
                        spellCheck={false}
